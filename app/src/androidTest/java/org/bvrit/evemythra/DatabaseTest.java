...
import org.bvrit.evemythra.dbutils.DatabaseOperations;
import org.bvrit.evemythra.dbutils.DbContract;
import org.bvrit.evemythra.dbutils.DbHelper;
...
public class DatabaseTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        Session session = new Session(5, "abcd", "abc", "abcdefgh", "sdfjs dsjfnjs",
                "2015-06-05T00:00:00", "2015-06-06T00:00:00", "2015-06-06", "1", new org.bvrit.evemythra.data.parsingExtra.Track(6, "kids"), "0", new org.bvrit.evemythra.data.parsingExtra.Microlocation(4, "moscone centre"));
