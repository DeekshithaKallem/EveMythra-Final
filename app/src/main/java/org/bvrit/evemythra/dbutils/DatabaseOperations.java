...
import org.bvrit.evemythra.data.parsingExtra.Track;
...
//    private static final String LIKE = " LIKE ";
    ...
    org.bvrit.evemythra.data.Microlocation getMicroLocationById(int id, SQLiteDatabase mDb) {
        ...
        org.bvrit.evemythra.data.Microlocation location = null;
        if (cursor != null && cursor.moveToFirst()) {
            while (!cursor.isAfterLast()) {

                //Should return only one due to UNIQUE constraint
                location = new org.bvrit.evemythra.data.Microlocation(
    ...
    List<org.bvrit.evemythra.data.Track> getTrackList(SQLiteDatabase mDb) {
        ...
        List<org.bvrit.evemythra.data.Track> tracks = new ArrayList<>();
        org.bvrit.evemythra.data.Track track;

        if (cursor != null && cursor.moveToFirst()) {
            while (!cursor.isAfterLast()) {
                track = new org.bvrit.evemythra.data.Track(
    ...
    ArrayList<org.bvrit.evemythra.data.Microlocation> getMicrolocationsList(SQLiteDatabase mDb) {
        ...
        ArrayList<org.bvrit.evemythra.data.Microlocation> microlocations = new ArrayList<>();
        org.bvrit.evemythra.data.Microlocation microlocation;

        if (cursor != null && cursor.moveToFirst()) {
            while (!cursor.isAfterLast()) {
                microlocation = new org.bvrit.evemythra.data.Microlocation(
                        cursor.getInt(cursor.getColumnIndex(DbContract.Microlocation.ID)),
                        cursor.getString(cursor.getColumnIndex(DbContract.Microlocation.NAME)),
                        cursor.getFloat(cursor.getColumnIndex(DbContract.Microlocation.LATITUDE)),
                        cursor.getFloat(cursor.getColumnIndex(DbContract.Microlocation.LONGITUDE)),
    ...
    ArrayList<Session> getSessionbyTracksname(String trackName, SQLiteDatabase mDb) {
    ...
    org.bvrit.evemythra.data.Track getTracksbyTracksname(String trackName, SQLiteDatabase mDb) {
        String tracksColumnSelection = DbContract.Tracks.NAME + EQUAL + DatabaseUtils.sqlEscapeString(trackName);
        ...
        org.bvrit.evemythra.data.Track selected = null;

        if (tracksCursor != null && tracksCursor.moveToFirst()) {

            selected = new org.bvrit.evemythra.data.Track(
    ...
    org.bvrit.evemythra.data.Track getTracksbyTracksId(int id, SQLiteDatabase mDb) {
    ...
    ArrayList<Session> getSessionbySpeakersname(String speakerName, SQLiteDatabase mDb) {
    ...
    Speaker getSpeakerbySpeakersname(String speakerName, SQLiteDatabase mDb) {
        String speakerColumnSelection = DbContract.Speakers.NAME + EQUAL + DatabaseUtils.sqlEscapeString(speakerName);
        Cursor speakersCursor = mDb.query(
                DbContract.Speakers.TABLE_NAME,
                DbContract.Speakers.FULL_PROJECTION,
    ...
    org.bvrit.evemythra.data.Microlocation getLocationByName(String speakerName, SQLiteDatabase mDb) {
    ...
    ArrayList<Session> getSessionbyLocationname(String locationName, SQLiteDatabase mDb) {
    ...
    ArrayList<Session> getSessionbyDate(String date, String sortOrder, SQLiteDatabase mDb) {
